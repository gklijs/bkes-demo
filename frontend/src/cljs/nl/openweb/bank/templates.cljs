...
(defn nav-bar
      ...
      [:nav#nav-bar.navbar.is-fixed-top {:role "navigation" :aria-label "main navigation"}
       [:div.navbar-brand
        ...
        [:a.navbar-item.is-hidden-desktop
         {:target "_blank", :href "https://github.com/gklijs/bob2021"}
...
(defn intro
      ...
      [:div.content
       ...
       [:p "From the navigation you can go to Bank-employee to see the other accounts or Client to open your own account."]])
